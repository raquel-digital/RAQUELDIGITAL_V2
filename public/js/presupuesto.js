...
socket.emit("pedir-presupuestos");
socket.on("enviar-presupuestos-res", (data) => {
    const { codeBasico, codeMedio, codePremium, test } = data;
    console.log(codeBasico, codeMedio, codePremium, test);
...
//     console.log(codeBasico, codeMedio, codePremium)
